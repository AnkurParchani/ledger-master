...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee2(username, password, passwordConfirm) {
    var res, expirationTime;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 3:
          ...
          if (res.data.status === "success") {
            ...
            (0, _alerts.showAlert)("success", "User created successfully", 1500); // Reloading the page
...
exports.showModal = exports.showDocumentsModal = exports.showContactModal = void 0;
...
var showDocumentsModal = function showDocumentsModal() {
  ...
  function closeModal() {
    document.querySelector(".showDocuments").insertAdjacentHTML("beforeend", "<div class='owl-carousel owl-theme documentsCarousel'>\n      </div>");
...
var showContactModal = function showContactModal() {
  var contactModal = document.querySelector(".contactModal");
  var modalBackdrop = document.querySelector(".modalBackdrop");
  var cancelBtn = document.querySelector(".contactCancelBtn"); // Opening the modal

  contactModal.classList.remove("hidden");
  modalBackdrop.style.display = "block"; // If user choose Cancel button
...
exports.showContactModal = showContactModal;
            ...
            return _regeneratorRuntime().wrap(function _loop$(_context) {
              while (1) switch (_context.prev = _context.next) {
                ...
                case 6:
                  ...
                  document.querySelector(".documentsCarousel").insertAdjacentHTML("beforeend", html);
...
var addDocs = document.querySelector(".addDocs"); // For signup
...
if (signupForm) {
  ...
  signupForm.addEventListener("submit", function (e) {
    ...
    var passwordConfirm = document.querySelector(".signup_passwordConfirm").value;
    (0, _login.signup)(username, password, passwordConfirm);
  });
} // For login
